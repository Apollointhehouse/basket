...
data class C2SMenuInteractionPacket(
    val windowId: Int,
    val slot: Int,
    ...
    companion object : PacketSerializer<C2SMenuInteractionPacket> {
        override fun deserialize(buffer: ReadBuffer): C2SMenuInteractionPacket {
            ...
            return C2SMenuInteractionPacket(
                windowId,
                slot,
                rightClicked,
                stateId,
