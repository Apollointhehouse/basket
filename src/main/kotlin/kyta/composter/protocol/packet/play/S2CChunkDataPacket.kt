...
data class S2CChunkDataPacket(val pos: ChunkPos, val data: Chunk) : Packet {
    companion object : PacketSerializer<S2CChunkDataPacket> {
        override fun serialize(packet: S2CChunkDataPacket, buffer: WriteBuffer) {
