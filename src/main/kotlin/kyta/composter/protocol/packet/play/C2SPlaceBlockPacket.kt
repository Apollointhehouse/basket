...
data class C2SPlaceBlockPacket(
    ...
    companion object : PacketSerializer<C2SPlaceBlockPacket> {
        private val SPECIAL_CASE_POS = BlockPos(-1, -1, -1)

        override fun deserialize(buffer: ReadBuffer): C2SPlaceBlockPacket {
            ...
            return C2SPlaceBlockPacket(pos, direction ?: BlockFace.NORTH, blockId, amount, metadata)
        }
    }
